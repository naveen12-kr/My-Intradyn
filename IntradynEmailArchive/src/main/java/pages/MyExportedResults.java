...
public class MyExportedResults extends BasePage {
	...
	public static final By byDownloadIcon = findBy("//*[@id='main']/div/div/div/div/table/tbody/tr[1]/td[4]/a/img");
	public static final By byShareIcon = findBy("//*[@id='main']/div/div/div/div/table/tbody/tr[1]/td[5]/button");
	public static final By byUnshareIcon = findBy("//*[@id=\"main\"]/div/div/div/div/table/tbody/tr[1]/td[6]/button");
	public static final By byUnshareSubmit = findBy("//*[@id='wrap']/div/div/div/div/div/input[1]"); 
	public static final By byDeleteIcon = findBy("//*[@id='main']/div/div/div/div/table/tbody/tr[1]/td[7]/a/img");
	...
	public static final By byFilenameArrow = findBy("//*[@id='main']/div/div/div/div/table/thead/tr/th[1]/a");
	public static final By bySizeArrow = findBy("//*[@id='main']/div/div/div/div/table/thead/tr/th[2]/a");
	public static final By byDateArrow = findBy("//*[@id='main']/div/div/div/div/table/thead/tr/th[3]/a");
	...
	public static void filedownloaded() {
		...
		String tname = driver.findElement(By.xpath("//*[@id=\"main\"]/div/div/div/div/table/tbody/tr[1]/td[4]/a")).getAttribute("title");
	...
	{
		String fileName = driver.findElement(By.xpath("//*[@id='main']/div/div/div/div/table/tbody/tr[1]/td[7]/a")).getAttribute("title");
		//System.out.println(fileName);
		
		clickElement(byDeleteIcon, "Delete");
		
		System.out.println(fileName+ " is ready for delete");
	}
	...
	List<WebElement> row= table.findElements(By.xpath("//*[@id=\"main\"]/div/div/div/div/table/tbody/tr/td[1]"));
	...
	Iterator<WebElement> itr = row.iterator();	
		...
		System.out.println("Files are in unsorted order");
	}
	...
	public static void isFilenamesortedOrder()
	{
		...
		public static void isSizeSortedOrder()
			{
			WebElement table = driver.findElement(By.xpath("//*[@id='main']/div/div/div/div/table"));
			List<WebElement> row= table.findElements(By.xpath("//*[@id=\"main\"]/div/div/div/div/table/tbody/tr/td[2]"));
			...
			while(itr.hasNext())
			{
					...
					if((name1.compareTo(name2)) < 0)
					{
					System.out.println("The file size are in accending Order");
					
				}
				else if((name1.compareTo(name2)) > 0)
				{
					System.out.println("The file size are in Decending Order");
				}
				else
				{
					System.out.print("Both the file sizes are same");
				}
				break;
		}
	}
	...
	{
		WebElement table = driver.findElement(By.xpath("//*[@id='main']/div/div/div/div/table"));
		List<WebElement> row= table.findElements(By.xpath("//*[@id=\"main\"]/div/div/div/div/table/tbody/tr/td[3]"));
		...
		while(itr.hasNext())
		{
				...
				if((name1.compareTo(name2)) < 0)
				{
					System.out.println("Dates are in accending Order");
					
				}
				else if((name1.compareTo(name2)) > 0)
				{
					System.out.println("Dates are in Decending Order");
				}
				else
				{
	...
	public static void setSearchTerms() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='searchterm']")).sendKeys("ram");
	...
	public static void listOfSelectedUsers()
	{
		...
		for(WebElement we:users)
		{
			...
			System.out.println("Selected User Name: "+s1);
		}
	}
