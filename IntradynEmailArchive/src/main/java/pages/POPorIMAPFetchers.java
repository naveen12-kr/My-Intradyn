...
public class POPorIMAPFetchers extends BasePage{
	...
	public static void getExistingFetcherErrorMsg() {
		...
		String message = driver.findElement(By.xpath("//div//li[contains(text(), 'This configuration ID already exists')]")).getText();
	...
	public static void getPortNumber() {
		...
		System.out.println("The port number field is populated as : " +port);
	}
	...
	public static void isStatusDescPresent() {
		
		driver.findElement(By.xpath("//*[@id='1']/dd/div")).isDisplayed();
		System.out.println("Element Status Description is not present on screen ");
	}
