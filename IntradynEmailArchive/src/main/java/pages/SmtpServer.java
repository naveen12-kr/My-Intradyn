...
public class SmtpServer extends BasePage {
	...
	public final static By byADDServerListButton = findBy("//*[@id=\"main\"]/div/div/div/div[3]/div[2]/form/input[3]");
   ...
   public static void clickOnADDServerListButton() {
	...
	public static void getSmtpRunning() {
		 ...
		 String message = driver.findElement(By.xpath("//*[@id='main']/div/div/div/div[1]/fieldset/form/dl/dt")).getText();
		 System.out.println(message);
	}
	
	public static void getADDServerError() {
		
		 String message = driver.findElement(By.xpath("//*[@id=\"main\"]/div/div/div/div[3]/div[2]/form/ul")).getText();
		 System.out.println(message);
	}
   ...
   public static void setValidDomain() {
	...
	public static void getThisFieldIsReq() {
		...
		String st = driver.findElement(By.xpath("//*[@id=\"main\"]/div/div/div/div[2]/form/fieldset/dl[1]/dd[2]/ul/li")).getText();
     ...
     public static void setExistingUserName() throws InterruptedException {
		...
		WebElement table = driver.findElement(By.xpath("//*[@class='bordered-table']//tbody"));
  		List<WebElement> row = table.findElements(By.xpath("//*[@id=\"main\"]/div/div/div/div[3]/table/tbody/tr/td[1]"));
  		Thread.sleep(2000);
     ...
     public static void addServerList() throws InterruptedException, AWTException {
    	...
    	driver.findElement(By.xpath("//*[@id='id_listfile']")).click();
 		...
 		setClipboardData(downloadpath +"\\work.txt");
 	...
 	public static void setClipboardData(String string) {
      ...
      public static void getMessage() {
		...
		String success = driver.findElement(By.xpath("//*[@id=\"main\"]/div/div/div/div/form/fieldset/dl/dd[2]/ul/li")).getText();
