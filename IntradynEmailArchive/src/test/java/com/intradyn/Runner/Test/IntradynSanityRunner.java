...
import pages.SendEmailWithAttachments;
...
public class IntradynSanityRunner extends BasePage{
	public static String excelPath = System.getProperty("user.dir")+"\\AddNewUser\\MYEXCEL.xlsx";
	

@BeforeClass
public static void classBefore() throws IOException, EmailException { 
...
public static void AfterClass() {
	...
	Reporter.setSystemInfo("URL :", EnvironmentUtils.getConfig().getProperty("qa7_intradyn_url"));
	Reporter.setSystemInfo("Version : ", EnvironmentUtils.getConfig().getProperty("version"));
	SendEmailWithAttachments.sendEmail();
