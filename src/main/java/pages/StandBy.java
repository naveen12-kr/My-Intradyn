...
public class StandBy extends BasePage {
	...
	/********************* Delete Icon ***********************************/
	public final static By byDeleteIcon = findBy(
			"//*[@id=\"main\"]/div/div/div/div/table/tbody/tr[2]/td[5]/form/input[2]");
	...
	public static boolean isStandByOverViewDisp() {

		return isElementPresent(byStandByOverViewDisp, "StandBy Over View");
	}

	public static boolean isScheduledownTimeFieldsPresent() {

		Assert.assertTrue(isElementPresent(byWeekdaysField, "Week Days"));
		Assert.assertTrue(isElementPresent(byShutdownField, "Shutdown Time"));
		Assert.assertTrue(isElementPresent(byReactivationField, "Reactivation Time"));
		return true;
	}

	public static boolean isAddingTargetDisp() {

		return isElementPresent(byAddingTargetDisp, "Adding Target Name Display");
	}

	public static boolean isProcessDetailsDisp() {

		return isElementPresent(byProcessDetailsDisp, "Process Details: Standby");
	}

	public static boolean isWarmStandByDisp() {

		return isElementPresent(byWarmStandByDisp, "Sheduling Warm Standby");
	}

	public static boolean isUpdateStandbyTargetDisp() {

		return isElementPresent(byUpdatedisp, "Update Standby Target");
	}

	public static void getUpdateTarget() {
