...
public class AddNewUserDef extends BasePage {
	...
	public void enter_new_user_name(String sText) throws Throwable {
		...
		user = getRandomStringsmallchr(8);
		UsersAndGroups.setAddUserText(user);
	...
	public void user_able_to_see_the_Select_Permissions() throws Throwable {
		Assert.assertTrue(UsersAndGroups.isSelectPermissionsText());
	...
	public void user_able_to_see_the_Set_home_page_details() throws Throwable {
		...
		Assert.assertTrue(UsersAndGroups.isSetHomepagedetails());
	}
	...
	public void user_able_to_see_the_Set_General_Search_Rule_details() throws Throwable {
		...
		Assert.assertTrue(UsersAndGroups.isSetGeneralSearchRuleText());
	}
	...
	public void user_able_to_see_Set_allowed_search_addresses_details() throws Throwable {
		...
		Assert.assertTrue(UsersAndGroups.isSetallowedsearchaddressesText());
	}
	...
	public void email_Fetcher_Configurations_page_should_open() throws Throwable {

	}

	@Then("^Enter Fetcher name to add fetcher$")
	public void enter_Fetcher_name_to_add_fetcher() throws Throwable {
		UsersAndGroups.setNewFetcherName("Fetcher" + getRandomStringsmallchr(6));
	...
	public void fetcher_Configuration_Form_should_open() throws Throwable {
		Assert.assertTrue(UsersAndGroups.isFetcherConfiguration());
	}
	...
	@Then("^user clicks on pencil icon in groups \"([^\"]*)\"$")
	public void user_clicks_on_pencil_icon_in_groups(int data) throws Throwable {
		UsersAndGroups.clickOnPencileIcon(data);
	}

	@Then("^message is displayed$")
	public void message_is_displayed() throws Throwable {
		UsersAndGroups.isMessageDisplayed();
	}

	@Then("^Remove the Added Data$")
	public void remove_the_Added_Data() throws Throwable {
		UsersAndGroups.isData();
	}
	@When("^User got the version$")
	public void user_got_the_version() throws Throwable {
		//String text=driver.findElement(findBy("//td[contains(text(),'Version')]/following::td[1]")).getText();
		String text=driver.findElement(findBy("//div[@id='page-footer']")).getText().substring(0,20);
		System.out.println("INFO Version: " + text );
		EnvironmentUtils.setProperty("version", text);
	}
