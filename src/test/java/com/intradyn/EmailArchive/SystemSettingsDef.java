...
public class SystemSettingsDef extends BasePage {
	...
	@When("^user set the time manually as \"([^\"]*)\"$")
	public void user_set_the_time_manually_as(String data) throws Throwable {
		SystemSettings.setDateAndTime(data);
	}
	...
	@Then("^\"([^\"]*)\" Message displayed$")
	public void message_displayed(String data) throws Throwable {
		SystemSettings.isInvalidMessageDisplayed(data);
	}
