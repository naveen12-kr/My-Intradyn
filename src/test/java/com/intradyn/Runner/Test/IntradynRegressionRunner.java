...
@CucumberOptions(tags = {}, features = { "src/test/resources/Features/Qahv_Regression1_6_8"}, glue = {
		"com.intradyn.EmailArchive" }, plugin = {
				"com.cucumber.listener.ExtentCucumberFormatter:target/output/RegressionReport.html",
...
public class IntradynRegressionRunner {
	...
	public static void AfterClass() {
		Reporter.setSystemInfo("URL :", EnvironmentUtils.getConfig().getProperty("Intradyn_6.4_qahv15"));
		Reporter.setSystemInfo("Version : ", EnvironmentUtils.getConfig().getProperty("version"));
		Reporter.setSystemInfo("Browser : ", BasePage.getBrowser());
		Reporter.setSystemInfo("Browser Version : ", BasePage.getVersion());
