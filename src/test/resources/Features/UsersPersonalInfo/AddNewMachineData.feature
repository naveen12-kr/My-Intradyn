...
Feature: UserAndGroups-Users
  ...
  Scenario: Add Search Term - past month
    ...
    And User Click on Test Expand icon
    When User clicks on Save Search Criteria tab
    And Enter user name and description "Desc"
    And click on saved search criteria save button
    When User clicks on "Saved Searches" tab
    And user clicks on the same

  Scenario: Add Search Term - 3Months
    When User clicks on "Email Viewing"
    When User clicks on "Search" tab
  ...
  Scenario: Add Search Term - six months
    And click on Query terms
    When User clicks on "Email Viewing"
    When User clicks on "Search" tab
  ...
  @Schedule1
  Scenario: Add Search Term - nine months
    When User clicks on "Email Viewing"
    When User clicks on "Search" tab
  ...
  Scenario: Add Schedule Searches
    When User clicks on "Email Viewing"
    When User clicks on "Saved Searches" tab
    Then User able to see header "Saved Search Queries"
    And user clicks on calender "Schedule" icon
    And Configure "weekdays" Scheduling Searches "1"
